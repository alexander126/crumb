...
Swift Package Manager is the preferred installation method for new native iOS integrations. CocoaPods plans to stop accepting new public registry releases on [2 December 2026](https://blog.cocoapods.org/CocoaPods-Specs-Repo/); existing published versions remain available. SPM installations are independent of that registry.
