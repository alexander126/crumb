...
struct CrumbCoreTests {
    ...
    func recoveryReappliesDisabledEvidenceToPreviouslyCapturedContext() throws {
        ...
        let settings = try Crumb.reportSettings()
        let context = CrumbJavaScriptFailureContext(stacks: CrumbFailureStacks(threads: [.init(index: 0, name: "Thread 0", state: "capture_thread", frames: ["SyntheticApp + 0x1234"])], truncated: false), capturedAt: Date(timeIntervalSince1970: 1_700_000_000),
